      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var EditorDrawer = function EditorDrawer(_ref) {
          ...
          (0, _react.useEffect)(function () {
            elementor.on(
              "elementor/editor/panel/whats-new/clicked",
              function () {
                ...
                onClick: function onClick() {
                  elementor.editorEvents.dispatchEvent(
                    elementor.editorEvents.config.names.topBar.whatsNew,
                    {
                      ...
                      secondaryLocation:
                        elementor.editorEvents.config.secondaryLocations[
                          "whats-new"
                        ],
                      trigger: elementor.editorEvents.config.triggers.click,
                      element:
                        elementor.editorEvents.config.elements.buttonIcon,
                    }
                  );
                  setIsRead(true);
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var WhatsNewItemTopicLine = function WhatsNewItemTopicLine(_ref) {
          ...
          return /*#__PURE__*/ _react.default.createElement(
            ...
            topic &&
              /*#__PURE__*/ _react.default.createElement(_ui.Box, null, topic),
            date &&
      ...
      /***/ (module) => {
        ...
        function dehydrate(client, options = {}) {
          ...
          const queries = client
            ...
            .getAll()
            .flatMap((query) =>
              filterQuery(query) ? [dehydrateQuery(query)] : []
            );
          ...
          queries.forEach(({ queryKey, state, queryHash, meta }) => {
            ...
            if (query) {
              if (query.state.dataUpdatedAt < state.dataUpdatedAt) {
                const { fetchStatus: _ignored, ...dehydratedQueryState } =
                  state;
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        __export(src_exports, {
          ...
          defaultShouldDehydrateQuery: () =>
            import_hydration.defaultShouldDehydrateQuery,
        ...
        var InfiniteQueryObserver = class extends import_queryObserver.QueryObserver {
            ...
            super.setOptions(
              {
                ...options,
                behavior: (0,
                import_infiniteQueryBehavior.infiniteQueryBehavior)(),
              },
              notifyOptions
            );
          }
          ...
          createResult(query, options) {
            ...
            return {
              ...
              hasPreviousPage: (0,
              import_infiniteQueryBehavior.hasPreviousPage)(
                options,
                state.data
              ),
              isFetchingNextPage,
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var MutationObserver = class extends import_subscribable.Subscribable {
          ...
          setOptions(options) {
            ...
            if (
              !(0, import_utils.shallowEqualObjects)(prevOptions, this.options)
            ) {
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var Query = class extends import_removable.Removable {
          ...
          fetch(options, fetchOptions) {
            ...
            const onError = (error) => {
              if (
                !((0, import_retryer.isCancelledError)(error) && error.silent)
              ) {
                this.#dispatch({
                  type: "error",
                  error,
  ...
  \*************************************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var QueryClient = class {
          ...
          constructor(config = {}) {
            this.#queryCache =
              config.queryCache || new import_queryCache.QueryCache();
            this.#mutationCache =
          ...
          mount() {
            ...
            this.#unsubscribeOnline =
              import_onlineManager.onlineManager.subscribe(() => {
          ...
          fetchInfiniteQuery(options) {
            options.behavior = (0,
            import_infiniteQueryBehavior.infiniteQueryBehavior)(options.pages);
            return this.fetchQuery(options);
          }
          ...
          defaultQueryOptions(options) {
            ...
            if (!defaultedOptions.queryHash) {
              ...
              import_utils.hashQueryKeyByOptions)(
  ...
  \********************************************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var HydrationBoundary = ({
          ...
          const client = (0, import_QueryClientProvider.useQueryClient)(
            queryClient
          );
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var getHasError = ({
          ...
          return (
            ...
            !result.isFetching &&
            (0, import_utils.shouldThrowError)(throwOnError, [
              result.error,
              query,
            ])
          );
  ...
  \********************************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        __export(src_exports, {
          ...
          QueryClientContext: () =>
            import_QueryClientProvider.QueryClientContext,
          QueryClientProvider: () =>
            import_QueryClientProvider.QueryClientProvider,
          QueryErrorResetBoundary: () =>
            import_QueryErrorResetBoundary.QueryErrorResetBoundary,
          infiniteQueryOptions: () =>
            import_infiniteQueryOptions.infiniteQueryOptions,
          ...
          useSuspenseQueries: () =>
            import_useSuspenseQueries.useSuspenseQueries,
  ...
  \***************************************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        function useBaseQuery(options, Observer, queryClient) {
          ...
          (0, import_errorBoundaryUtils.useClearResetErrorBoundary)(
            errorResetBoundary
          );
            ...
            ? optimisticResult.flatMap((result, index) => {
                ...
                if (opts) {
                  ...
                  if (
                    ...
                    (0, import_suspense.willFetch)(result, isRestoring)
                  ) {
