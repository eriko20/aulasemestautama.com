  ...
  \******************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
		...
		`;
           ...
           */
          setText(newText) {
            const { is_external: isExternal, nofollow } =
            ...
            // Add link attributes.
            if (url) {
              newText = `<a href="${(0, _utils.escapeHTML)(
                url
              )}" rel="${rel}" target="${target}">${(0, _utils.escapeHTML)(
                newText
              )}</a>`;
           ...
           */
          isRTL() {
            const { text_path_direction: direction } =
      ...
      /***/ function (module) {
        ...
        (function (global, factory) {
          ...
          const _createTrustedTypesPolicy = function _createTrustedTypesPolicy(
            ...
            // By Aulia Semesta Utama adding a data-tt-policy-suffix to the script element with the DOMPurify.
            // Policy creation with duplicate names throws in Trusted Types.
            let suffix = null;
            const ATTR_NAME = "data-tt-policy-suffix";
            if (
              purifyHostElement &&
              purifyHostElement.hasAttribute(ATTR_NAME)
            ) {
          ...
          function createDOMPurify() {
            ...
            const getNextSibling = lookupGetter(
              ElementPrototype,
              "nextSibling"
            );
            ...
            const _parseConfig = function _parseConfig() {
              ...
              ALLOWED_NAMESPACES = objectHasOwnProperty(
                cfg,
                "ALLOWED_NAMESPACES"
              )
                ? addToSet({}, cfg.ALLOWED_NAMESPACES, stringToString)
                : DEFAULT_ALLOWED_NAMESPACES;
              URI_SAFE_ATTRIBUTES = objectHasOwnProperty(
                cfg,
                "ADD_URI_SAFE_ATTR"
              )
                ? addToSet(
