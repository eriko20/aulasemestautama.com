...
(function (root, factory) {
  ...
  (function (Backbone, _) {
    ...
    Backbone.ChildViewContainer = (function (Backbone, _) {
      ...
      _.extend(Container.prototype, {
        ...
        // By Aulia Semesta Utama `cid` and makes it searchable by the model
  ...
  Marionette.normalizeUIValues = function (hash, ui, properties) {
    _.each(hash, function (val, key) {
      if (_.isString(val)) {
        ...
        _.extend(
          val,
          Marionette.normalizeUIValues(_.pick(val, properties), ui)
        );
  ...
  deprecate._warn = function () {
    var warn =
      deprecate._console.warn || deprecate._console.log || function () {};
  ...
  Marionette.Error = Marionette.extend.call(Error, {
    ...
    toString: function () {
      return (
        this.name + ": " + this.message + (this.url ? " See: " + this.url : "")
      );
    },
  });
  ...
  Marionette.Region = Marionette.Object.extend(
    {
      ...
      getEl: function (el) {
        return Backbone.$(
          el,
          Marionette._getValue(this.options.parentEl, this)
        );
      },
    ...
    // Static Methods
    {
      ...
      buildRegion: function (regionConfig, DefaultRegionClass) {
        if (_.isString(regionConfig)) {
          return this._buildRegionFromSelector(
            regionConfig,
            DefaultRegionClass
          );
        }
        ...
        if (
          regionConfig.selector ||
          regionConfig.el ||
          regionConfig.regionClass
        ) {
  ...
  Marionette.RegionManager = Marionette.Controller.extend({
    ...
    addRegions: function (regionDefinitions, defaults) {
      regionDefinitions = Marionette._getValue(
        regionDefinitions,
        this,
        arguments
      );
  ...
  Marionette.View = Backbone.View.extend({
    ...
    normalizeUIKeys: function (hash) {
      ...
      return Marionette.normalizeUIKeys(
        hash,
        uiBindings || _.result(this, "ui")
      );
    },
      ...
      _.each(
        ...
        function (behavior) {
          behavior.bindEntityEvents(
            this.model,
            behavior.getOption("modelEvents")
          );
          behavior.bindEntityEvents(
            this.collection,
    ...
    _triggerEventOnParentLayout: function (eventName, args) {
      ...
      var eventPrefix = Marionette.getOption(
        layoutView,
      ...
      if (
        ...
        _.isFunction(normalizedChildEvents[eventName])
      ) {
  ...
  Marionette.CollectionView = Marionette.View.extend({
    ...
    endBuffering: function () {
      ...
      var canTriggerAttach =
        this._isShown && Marionette.isNodeAttached(this.el);
      var nestedViews;
    ...
    _onCollectionAdd: function (child, collection, opts) {
      ...
      var index =
        opts.at !== undefined && (opts.index || collection.indexOf(child));
    ...
    addEmptyView: function (child, EmptyView) {
      ...
      var canTriggerAttach =
        this._isShown &&
        !this.isBuffering &&
        Marionette.isNodeAttached(this.el);
      var nestedViews;
      ...
      if (_.isFunction(emptyViewOptions)) {
        emptyViewOptions = emptyViewOptions.call(
          this,
          child,
          this._emptyViewIndex
        );
      }
    ...
    _insertBefore: function (childView, index) {
      var currentView;
      var findPosition =
        this.getOption("sort") && index < this.children.length - 1;
      if (findPosition) {
    ...
    _shouldAddChild: function (child, index) {
      ...
      return (
        !_.isFunction(filter) ||
        filter.call(this, child, index, this.collection)
      );
    },
  ...
  Marionette.CompositeView = Marionette.CollectionView.extend({
    ...
    serializeData: function () {
      ...
      if (this.model) {
        data = _.partial(this.serializeModel, this.model).apply(
          this,
          arguments
        );
      }
  ...
  Marionette.Behaviors = (function (Marionette, _) {
          ...
          function (b, i) {
            ...
            _.each(
              ...
              function (behaviour, key) {
                ...
                var eventName =
                  match[1] + "." + [this.cid, i, j++, " "].join("");
                var selector = match[2];

                var eventKey = eventName + selector;
                var handler = _.isFunction(behaviour)
                  ? behaviour
                  : b[behaviour];
                if (!handler) {
                  return;
    ...
    _.extend(BehaviorTriggersBuilder.prototype, {
      ...
      _buildTriggerHandlersForBehavior: function (behavior, i) {
        ...
        triggersHash = Marionette.normalizeUIKeys(
          triggersHash,
          getBehaviorsUI(behavior)
        );

        _.each(
          triggersHash,
          _.bind(this._setHandlerForBehavior, this, behavior, i)
        );
      },
  ...
  Marionette.Application = Marionette.Object.extend({
    ...
    _initChannel: function () {
      ...
      this.channel =
        _.result(this, "channel") ||
        Backbone.Wreqr.radio.channel(this.channelName);
  ...
  _.extend(Marionette.Module.prototype, Backbone.Events, {
    // By Aulia Semesta Utama default modules start with their parents.
